...
//        closeButton.setImage(UIImage(named: "close_btn_tap")?.withRenderingMode(.alwaysTemplate), for: .normal) // "xmark.circle" 아이콘 사용
...
////        ]
//        imageNames = ["n0","n1","n2","n4","n5","hq","n15","slim2","seg0","seg1","remove0","remove1","outfocus0",
//                      "makeup0","makeup1","makeup2","makeup3","makeup4","makeup5","makeup6","n31","n6"
//        ]
//        descs = [ "subscribe_desc0".localized,"subscribe_desc6".localized,"subscribe_desc6".localized,
//                  "subscribe_desc6".localized,"subscribe_desc6".localized,"subscribe_desc3".localized,
//                  "subscribe_desc4".localized,"subscribe_desc4".localized,"subscribe_desc5".localized,
//                  "subscribe_desc5".localized,"subscribe_desc7".localized,"subscribe_desc8".localized,
...
//        SwiftyStoreKit.retrieveProductsInfo(["com.junsoft.beautycameravip", "com.junsoft.beautycameravipw", IAPHelper.premium]) { [self] result in
//            for product in result.retrievedProducts {
//                let identifier = product.productIdentifier
//                let priceString = product.localizedPrice ?? ""
//                
//                if identifier == IAPHelper.premium {
...
////                                button.setTitle(title, for: .normal)
//                                
//                                button.setTitle(title, subtitle: "\(formattedMonthlyPrice) / " + "month".localized)
//
//                            }
//
//                        }
...
//                }
//                
//                else if identifier == "com.junsoft.beautycameravip" {
...
//        //
//        //        }
//        var product :String = "com.junsoft.beautycameravip12"
//        //        var type = 2
//        if selectedPlan == .basic{
//            product = "com.junsoft.beautycameravip"
//      
//        }
//        else{
//            product = "com.junsoft.beautycameravip12"
//      
//        }
//      
...
//        gradientLayer.colors = [/*Constants.yellow0.cgColor, */ UIColor.systemYellow.cgColor,Constants.pink2.cgColor,UIColor.systemRed.cgColor/*,UIColor.systemBlue.cgColor*/]
