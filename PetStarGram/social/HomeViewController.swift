...
class HomeViewController: MDCCollectionViewController{
    ...
    let paginationHelper = MGPaginationHelper<JPost>(pageSize:10, serviceMethod: UserService.timeline)
    let paginationHelper2 = MGPaginationHelper<JPost>(pageSize:10, serviceMethod: UserService.postsAll)
